...
from src.data_quality.gold_checks import gold_validation 

logger = get_logger('gold')
logger.info('Iniciando construção da gold...')
...
try:
    ...
    logger.info('Iniciando Data Quality da gold...')
    ...
    logger.info('Merge da gold executado com sucesso!!')
    ...
    logger.exception(f'Erro ao construir a gold: {e}')
    raise
